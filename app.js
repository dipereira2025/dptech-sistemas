...
function getConfigVisual(){
  return JSON.parse(localStorage.getItem('dptech_visual_config') || '{}');
}

function setConfigVisual(cfg){
  localStorage.setItem('dptech_visual_config', JSON.stringify(cfg));
}
...
function carregarLogoLocal(event){
...
function salvarPersonalizacao(){
  ...
  setConfigVisual(cfg);
  aplicarConfigVisual();
  alert('Personalização salva neste navegador.');
}
